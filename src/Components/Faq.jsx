...
const Faq = () => {
  return (
    // <div>
    //   <div className="h-44 bg-white-400 flex relative">
    //     <img src="/faq.jpg" className="w-full object-cover opacity-50" />
    //     <div className="absolute text-customBlue text-2xl font-semibold flex flex-col h-full justify-center text-center items-center w-full">
    //       <p>The Leading Consultancy In India & Japan</p>
    //       <p>FAQ</p>
    //     </div>
    //   </div>
    ...
    //     <div className="py-4 sm:w-1/2 sm:h-full flex flex-col justify-between">
    //       <FaqAccordion
    ...
    //       <FaqAccordion
    //         title={"How Do I Find Whether a Consultancy Is Fake Or Not??"}
    //         anss={
    ...
    //       <FaqAccordion
    //         title={"How Do I Know That WSNE Consulting Pvt. Ltd. Is The Right Consulting Agency For Me?"}
    //         anss={
    ...
    //         <button className="bg-customBlue py-2 px-6 rounded-lg hover:bg-customLiteBlue duration-300 text-white text-2xl font-sm">
    //           Send Message
    //         </button>
    //       </div>
    //     </div>
