...
const OurMission = () => {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center bg-[#fdfdfd] shadow-2xl rounded-lg px-6 py-12 sm:px-12 mx-4 my-6 space-y-6 sm:space-y-0 sm:gap-12 transition-transform transform hover:scale-105">
      ...
      <div className="sm:w-1/2 flex flex-col justify-center  sm:text-left">
        ...
        <p className="text-lg text-customBlue font-sm leading-relaxed opacity-90 hover:opacity-100 transition-opacity duration-300">
