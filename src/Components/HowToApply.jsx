    ...
    if (Object.keys(newErrors).length === 0) {
      emailjs.send(
        ...
        .then(() => {
          ...
          setFormData({ fullName: '', email: '', school: '', phoneNumber: '', enquiry: '' });
          toggleModal();
        })
        .catch((error) => {
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {/* Full Name */}
                <input
                  className={`h-12 border-b ${errors.fullName ? "border-red-500" : "border-gray-300"
                ...
                {/* Email Address */}
                <input
                  className={`h-12 border-b ${errors.school ? "border-red-500" : "border-gray-300"
                    } focus:border-blue-500 outline-none px-3 text-gray-700 transition-colors duration-200`}
                  type="text"
                  name="school"
                ...
                <input
                  className={`h-12 border-b ${errors.email ? "border-red-500" : "border-gray-300"
                    } focus:border-blue-500 outline-none px-3 text-gray-700 transition-colors duration-200`}
                  type="email"
                  name="email"
                ...
                {/* Phone Number */}
                <input
                  className={`h-12 border-b ${errors.phoneNumber ? "border-red-500" : "border-gray-300"
                    } focus:border-blue-500 outline-none px-3 text-gray-700 transition-colors duration-200`}
                  type="text"
                  name="phoneNumber"
                ...
                {/* Enquiry */}
                <textarea
                  className={`block w-full h-28 border-b ${errors.enquiry ? "border-red-500" : "border-gray-300"
