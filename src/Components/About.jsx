    ...
    <div>
      ...
      <div className="py-12 sm:px-24 ">
        ...
        <div className="flex justify-center  items-center  flex-wrap gap-4 m-1 sm:m-o">
          <div className="border-2 border-orange-500 flex flex-col items-center sm:h-56 sm:w-44 w-11/12 h-36 justify-center   rounded-tl-xl rounded-br-xl hover:scale-110 transition-all duration-200 hover:bg-customLiteBlue hover:text-white">
          ...
          <div className="border-2 border-orange-500 flex flex-col items-center sm:h-56 sm:w-44 w-11/12 h-36 justify-center  text-center  rounded-tl-xl rounded-br-xl hover:scale-110 transition-all duration-200 hover:bg-customLiteBlue hover:text-white">
